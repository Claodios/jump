...
// ===========================
function preload() {
    backgroundImg = loadImage("background.png", imageLoaded);
    doodlerLeftImg = loadImage("character.png", imageLoaded);
    doodlerRightImg = loadImage("character2.png", imageLoaded);
    platformImg = loadImage("platform.png", imageLoaded);
  }
  
  function imageLoaded() {
    // called once each image is loaded
    // check if all images are loaded
    if (backgroundImg && doodlerLeftImg && doodlerRightImg && platformImg) {
